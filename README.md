# Creative Asset Analyzer Algorithm Sample

This project was generated with [Angular CLI](https://github.com/angular/angular-cli) version 1.0.3.

# Add your COSMOS API Keys
Find the file 'COSMOS-Accelerators-Cognitive-Vision /src/app/services/ cognitive-api.service.ts ' and add your own COSMOS API keys.
...
1. `git clone https://github.com/cosmos-cognitive-cloud/COSMOS-Accelerators-Cognitive-Vision`
...
6. Success!  You should see a working demo of the Creative Asset Analyzer Algorithm built on Angular.
